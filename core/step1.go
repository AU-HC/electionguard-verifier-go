...
func (v *Verifier) validateParameters(er *deserialize.ElectionRecord) {
	...
	hashP := crypto.Hash1(&g, ver, "00", &p, &q, &g)
	hashM := crypto.Hash1(&g, hashP, "01", schema.MakeBigIntFromString("2388DAE2DAD9E79ED64BD2C5401C361BDA77B9019EA8C6F416568185679B4854", 16))
	hashQ := crypto.Hash1(&g, hashP, "02", 5, 3, hashM)
