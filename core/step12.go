...
func (v *Verifier) validateCorrectnessOfDecryptionsForSpoiledBallots(er *schema.ElectionRecord) {
...
func findBallot(name string, er *schema.ElectionRecord) (schema.SubmittedBallot, bool) {
