...
func main() {
	...
	if !hashP.Compare(expectedHashP) {
		fmt.Println("Wanted hashP: ", expectedHashP.Text(16))
		fmt.Println("Got hashP: ", hashP.Text(16))
	}
	...
	expectedHashM := schema.MakeBigIntFromString("8F91FBD8905679F8E7BB52D7BED30240BD1DB7EC4146646D1A2D1F92CAE41EDD", 16)
	if !hashM.Compare(expectedHashM) {
		fmt.Println("Wanted hashM: ", expectedHashM.Text(16))
		fmt.Println("Got hashM: ", hashM.Text(16))
	}
